...
public class Window {
	...
	public static void main(String[] args) {
		...
		Button lambdaButton2 = (Integer tempsDuClick) -> {
			return "lambda button appuyé pendant " + tempsDuClick;
		};
		// équivaut à :
		Button lambdaButton = tempsDuClick -> "lambda button appuyé pendant " + tempsDuClick;

		Consumer<Object> basicConsumer = (Object a) -> {
			System.out.println(a);
		};
		// équivaut à :
		Consumer<Object> basicConsumer2 = a -> System.out.println(a);

		// Variable effectivement final, utilisable dans une lambda
		int b = 4;
		...
		// plein de lignes de codes plus tard, exécutera la lambda
		window.execute();
